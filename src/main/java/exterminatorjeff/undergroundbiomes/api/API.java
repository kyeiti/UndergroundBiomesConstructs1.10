...
public final class API {
  ...
  public static final StoneEntry IGNEOUS_MOSSY_COBBLE = new StoneEntry("igneous_mossy_cobble");
  ...
  public static final StoneEntry METAMORPHIC_MOSSY_COBBLE = new StoneEntry("metamorphic_mossy_cobble");
  ...
  public static final StoneEntry SEDIMENTARY_MOSSY_COBBLE = new StoneEntry("sedimentary_mossy_cobble");
  /*
   * Slabs
   */
